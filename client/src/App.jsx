...
const App = () => {
  ...
  return (
    <Router>
      ...
      <Routes>
        <Route path="/" element={<Home openRoleSignUpModal={openRoleSignUpModal} openRoleLoginModal={openRoleLoginModal}/>} />
        <Route path="/about" element={<About  openRoleSignUpModal={openRoleSignUpModal}/>} />
